...
public partial class @FPSInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@FPSInputActions()
    {
        Debug.Assert(!m_DefaultMap.enabled, "This will cause a leak and performance issues, FPSInputActions.DefaultMap.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, FPSInputActions.UI.Disable() has not been called.");
    }
