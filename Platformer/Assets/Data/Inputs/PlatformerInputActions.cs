...
public partial class @PlatformerInputActions: IInputActionCollection2, IDisposable
{
    ...
    {
        Debug.Assert(!m_GameplayMap.enabled, "This will cause a leak and performance issues, PlatformerInputActions.GameplayMap.Disable() has not been called.");
        Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, PlatformerInputActions.Newactionmap.Disable() has not been called.");
    }
